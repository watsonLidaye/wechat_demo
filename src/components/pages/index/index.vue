	...
	<div id="index"  >
		<div class="banner">
			...
			<mt-swipe :show-indicators="false" class="w_100 h_100">
				  <mt-swipe-item>
				  	<img src="./image/banner_img@2x.png" class="w_100 h_100">
				  </mt-swipe-item>
				  <mt-swipe-item>
				  	<img src="./image/banner_img@2x.png" class="w_100 h_100">
				  </mt-swipe-item>
		...
		<div class="pb_tabbas">
			<router-link to="/jobdetail" class="block relative w_100 pd30 box_border pb15">
		...
		<div class="tabbas flex_align">
			<div class="w_50 juc_colum_b ft20">
